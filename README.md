...
Bureau can be used with your own LDAP server or with the managed LDAP platform hosted at [opendirectory.net](https://opendirectory.net). Without any configuration file provided, bureau will automatically load a test file from the example acccount on OpenDirectory.

## Managed LDAP

1. Install bureau on the target system.
...
3. View the test file:
```
$ cat /tmp/bureau.txt
# This file was automatically generated by bureau.
